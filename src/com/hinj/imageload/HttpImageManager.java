 ...
 * upon successful download. Following code com.app.wedia.view.modules shows how it is used in a customer list adapter.
 * 
 * <p>
 * <pre>
 *         ...
...
public class HttpImageManager{
    ...
    public static class LoadRequest {
        ...
        public LoadRequest(Uri uri, ImageView v, OnLoadResponseListener l){
            ...
            System.out.println("Print the Path of the Image :"+mHashedUri);
            mImageView = v;
            mListener = l;
        }
        ...
        private String computeHashedName (String name) {
        	...
        	System.out.println("Print the path of the Images 1:"+name);
            try {
